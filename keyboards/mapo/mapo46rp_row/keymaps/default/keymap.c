...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_ortho_4x12(
       KC_GRV,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                 LW_Y,    KC_U,    KC_I,    KC_O,   KC_P,  KC_RBRC,
  ...
  [_LOWER] = LAYOUT_ortho_4x12(
      ...
      XXXXXXX, XXXXXXX,KC_SPACE,KC_SPACE, MS_BTN1, MS_BTN3,              MS_BTN2, MS_BTN2,KC_ENTER, KC_BSPC, XXXXXXX, XXXXXXX
    ),
