...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_ortho_4x12(
     C(KC_SPC),   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                 KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,  KC_RBRC,
      KC_LGUI,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                 KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_BSLS,
      KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                 KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_INT1,
      KC_LCTL, KC_LALT,   RS_SP,   LW_SP, MS_BTN1, XXXXXXX,              XXXXXXX, MS_BTN2,KC_ENTER, KC_BSPC,  RS_DEL,   TR_EQ
    ),
  [_LOWER] = LAYOUT_ortho_4x12(
       KC_TAB, S(KC_1), S(KC_2),   KC_UP, S(KC_4), S(KC_5),              S(KC_6), S(KC_7), S(KC_8), S(KC_9), S(KC_0), KC_MINS,
      KC_LGUI,LSG(KC_RBRC),KC_LEFT,KC_DOWN,KC_RGHT,LSG(KC_BSLS),         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,S(KC_SCLN), KC_QUOT,
      KC_LSFT, XXXXXXX, XXXXXXX, KC_HASH, XXXXXXX, XXXXXXX,              KC_LBRC,  KC_EQL, KC_INT3, XXXXXXX, XXXXXXX, XXXXXXX,
      GUI_TAB, XXXXXXX, KC_INT5,KC_SPACE, MS_BTN1, XXXXXXX,              XXXXXXX, MS_BTN2,KC_ENTER, KC_BSPC, XXXXXXX, LSG(KC_3)
    ),
  [_RAISE] = LAYOUT_ortho_4x12(
       KC_ESC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                 KC_6,    KC_7,    KC_8,    KC_9,   KC_0,  KC_BSPC,
      KC_LGUI,   KC_F1, KC_LEFT, KC_DOWN, KC_RGHT,   KC_F5,               KC_APP,   KC_UP, XXXXXXX, KC_UNDS, KC_DQUO, KC_COLN,
      KC_LSFT,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,              KC_LEFT, KC_DOWN, KC_RGHT,  KC_DOT, KC_SLSH, KC_MINS,
      XXXXXXX, XXXXXXX, XXXXXXX,KC_SPACE, MS_BTN1, XXXXXXX,              XXXXXXX, MS_BTN2,KC_ENTER, KC_BSPC, XXXXXXX, XXXXXXX
    ),
